...
public partial class MainWindowViewModel : ObservableObject
{
    ...
    private async Task OnNavigationRequested(object? sender, NavigationEventArgs e)
    {
        ViewModelBase? newVm = e.ViewModelType switch
        {
            ...
            ViewModelType.TimeOffRequests => new TimeOffRequestsViewModel(_navigationService),
            ...
            ViewModelType.InternAttendance => new InternAttendanceViewModel(_navigationService),
