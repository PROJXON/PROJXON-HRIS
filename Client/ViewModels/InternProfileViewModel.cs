...
/// </summary>
public partial class InternProfileViewModel : ViewModelBase
{
    ...
    [ObservableProperty]
    private ObservableCollection<InternDocumentItem> _documents = new();

    #endregion

    public InternProfileViewModel(INavigationService navigationService)
    {
    ...
    public InternProfileViewModel() : this(null!)
    {
    }
    ...
    private void LoadMockData()
    {
        ...
        // Documents
        Documents = new ObservableCollection<InternDocumentItem>
        {
            new InternDocumentItem
            {
    ...
    [RelayCommand]
    private async Task ViewDocumentAsync(InternDocumentItem? document)
    {
    ...
    {
        // Already on profile, could refresh data
        await Task.CompletedTask;
    }
...
/// </summary>
public class InternDocumentItem
{
