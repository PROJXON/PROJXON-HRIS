...
/// </summary>
public partial class InternAttendanceViewModel : ViewModelBase
{
    ...
    [ObservableProperty]
    private string _userName = "Sarah Johnson";
    ...
    [ObservableProperty]
    private ObservableCollection<InternCalendarDayViewModel> _calendarDays = new();

    [ObservableProperty]
    private InternCalendarDayViewModel? _selectedDay;
    ...
    public InternAttendanceViewModel(INavigationService navigationService)
    {
    ...
    public InternAttendanceViewModel() : this(null!)
    {
    }
    ...
    private void GenerateCalendar()
    {
        ...
        {
            CalendarDays.Add(new InternCalendarDayViewModel
            {
                IsEmpty = true,
        ...
        for (int day = 1; day <= daysInMonth; day++)
        {
            ...
            var calendarDay = new InternCalendarDayViewModel
            {
                Date = date,
                DayNumber = day,
                IsToday = date == today,
    ...
    private void SetMockAttendanceData(InternCalendarDayViewModel day, int dayNumber)
    {
    ...
    [RelayCommand]
    private void SelectDay(InternCalendarDayViewModel? day)
    {
...
/// </summary>
public partial class InternCalendarDayViewModel : ObservableObject
{
    [ObservableProperty]
