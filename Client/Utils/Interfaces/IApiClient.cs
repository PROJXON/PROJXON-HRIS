...
public interface IApiClient
{
    ...
    Task<ApiResponse<object?>> PostAsync<T>(string endpoint, object data, CancellationToken cancellationToken = default);
    Task<ApiResponse<object?>> PutAsync<T>(string endpoint, int id, object data, CancellationToken cancellationToken = default);
