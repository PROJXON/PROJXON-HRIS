        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    contact_info_address_address_line1 = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    contact_info_address_address_line2 = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
                    contact_info_address_country = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    contact_info_address_state_or_province = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    contact_info_address_city = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    contact_info_address_postal_code = table.Column<string>(type: "character varying(15)", maxLength: 15, nullable: false),
                    contact_info_address_time_zone = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    user_settings = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_invited_users_user_response_invited_by_employee_id",
                        column: x => x.invited_by_employee_id,
                        principalTable: "user_response",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                });
