...
namespace CloudSync.Migrations
{
    ...
    [Migration("20260124103808_AddTimeOffRequests")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CloudSync.Modules.EmployeeManagement.Models.EmployeeFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_employee_files");

                    b.HasIndex("EmployeeId")
                        .HasDatabaseName("ix_employee_files_employee_id");

                    b.ToTable("employee_files", (string)null);
                });
            ...
            modelBuilder.Entity("CloudSync.Modules.EmployeeManagement.Models.TimeOffRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("EmployeeId")
                        .HasDatabaseName("ix_time_off_requests_employee_id");

                    b.HasIndex("Status")
                        .HasDatabaseName("ix_time_off_requests_status");

                    b.HasIndex("SubmittedDate")
                        .HasDatabaseName("ix_time_off_requests_submitted_date");
            ...
            modelBuilder.Entity("CloudSync.Modules.EmployeeManagement.Models.EmployeeFile", b =>
                {
                    b.HasOne("CloudSync.Modules.EmployeeManagement.Models.Employee", "Employee")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_employee_files_employees_employee_id");
            ...
            modelBuilder.Entity("CloudSync.Modules.EmployeeManagement.Models.TimeOffRequest", b =>
                {
                    b.HasOne("CloudSync.Modules.EmployeeManagement.Models.Employee", "Employee")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_time_off_requests_employees_employee_id");
