...
namespace CloudSync.Migrations
{
    ...
    [Migration("20250916102039_Add_EmployeeTechnicalSpec")]
    partial class Add_EmployeeTechnicalSpec
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CloudSync.Modules.EmployeeManagement.Models.EmployeeTechnicalSpec", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_employee_technical_specs");

                    b.ToTable("employee_technical_specs", (string)null);
                });
            ...
            modelBuilder.Entity("CloudSync.Modules.EmployeeManagement.Models.EmployeeTechnicalSpec", b =>
                {
                    b.HasOne("CloudSync.Modules.EmployeeManagement.Models.Employee", "Employee")
                        ...
                        .HasForeignKey("CloudSync.Modules.EmployeeManagement.Models.EmployeeTechnicalSpec", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_employee_technical_specs_employees_id");
